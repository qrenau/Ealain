...
int main(int argc, char* argv[])
{
    ...
    ealain::camera::Omnibinary::Domain domain(p_map);
    ...
    std::vector<ealain::camera::Omnibinary> cameras;
    ...
    for (int i=0; i<nb_cameras; i++)
    {
        ...
        ealain::camera::Omnibinary camera(map, p_map, point[0], point[1], n/range);
